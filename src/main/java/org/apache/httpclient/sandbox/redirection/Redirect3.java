...
public class Redirect3 {
	...
	public static void main(String[] args) throws ClientProtocolException, IOException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, CertificateException, InterruptedException {
...
//	        
		...
		// Enable authentication so framework automatically handles 407 responses from
		// Proxy server.
